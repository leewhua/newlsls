...
public class HbaseReadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,
		...
		try{
			...
			if (request.getParameter("long")!=null){
				returnvalue = String.valueOf(HBaseRead.getinstance().getlong(namespace, tablename, hash, row, column));
			} else {
				returnvalue = HBaseRead.getinstance().getstring(namespace, tablename, hash, row, column);
			}
