...
public class TrendServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,
		...
		try{
			...
			Map<String, Object> data = DataFiles.lucktrend(result.get("eid").toString(), request.getParameter("from"), request.getParameter("province"), request.getParameter("city"), 
			...
			if ("luckuser".equals(request.getParameter("datatype"))) {
				data = DataFiles.luckusertrend(result.get("eid").toString(), request.getParameter("from"), request.getParameter("province"), request.getParameter("city"), 
						request.getParameter("begin"), request.getParameter("end"), request.getParameter("gender"), 
						request.getParameter("activity"), request.getParameter("product"));
			} else if ("confirmprize".equals(request.getParameter("datatype"))) {
				data = DataFiles.confirmprizetrend(result.get("eid").toString(), request.getParameter("from"), request.getParameter("province"), request.getParameter("city"), 
						request.getParameter("begin"), request.getParameter("end"), request.getParameter("gender"), 
						request.getParameter("activity"), request.getParameter("product"));
			}
