...
public class ToactiveServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,
		...
		try{
			...
			result.putAll(DataFiles.toactive(result.get("eid").toString(), request.getParameter("begin"), request.getParameter("end")));
