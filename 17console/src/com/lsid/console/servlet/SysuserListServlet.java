...
public class SysuserListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,
		...
		try{
			...
			result.put("data", DataFiles.list(request.getAttribute(request.getParameter("t0ken")+"self").toString().substring(0, request.getAttribute(request.getParameter("t0ken")+"self").toString().indexOf(AutoConfig.SPLIT))));
