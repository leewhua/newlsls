...
public class FileCache4Later {
	public static void later(String namespace, String tablename, String column, String hash, String row, String value) throws Exception{
		...
		if (tablename.equals("a")||tablename.equals("na")) {
			writefile(namespace, "once", "put"+AutoConfig.SPLIT+hash+AutoConfig.SPLIT+row+AutoConfig.SPLIT+"po"+AutoConfig.SPLIT+"");
		}
	...
	public static void writefile(String namespace, String tablename, String content) throws Exception{
		...
		Path thefolder = Paths.get(AutoConfig.config(null,"cachelaterfolder")).resolve("writehbaselater").resolve(namespace);
