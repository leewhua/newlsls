...
public class WriteCacheServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req,
		...
		try{
			...
			FileCache4Later.later(namespace, tablename, column, hash, row, value);
			
			CacheUtil.writecache(namespace, tablename, column, hash, row, value);
