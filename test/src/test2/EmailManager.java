...
public class EmailManager {
    ...
    public static String username = "huameifood@huameifood.com"; // 服务邮箱(from邮箱)
    public static String password = "hUAMEI2017"; // 邮箱密码
    public static String senderNick = "华美食品";   // 发件人昵称
    ...
    public EmailManager() {
        ...
        props.put("mail.smtp.host", "pop.exmail.qq.com");
...
//          mimeMsg.setFrom(new InternetAddress(from));
    ...
    public static void main(String[] args) {
        ...
        String[] to = {"roger.chen@geopeo.com"};
        String[] copyto = {};
        String subject = "测试一下";
