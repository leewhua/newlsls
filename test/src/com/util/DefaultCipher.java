...
public class DefaultCipher {
    ...
    public static void main(String[] s) throws Exception{
    	System.out.println(MD5Hash.getMD5AsHex(enc("33645408306144").getBytes()).substring(0,1)+enc("33645408306144"));
    	//zNHBe7C6OCaPFOD0uJNAyw%3D%3D
    	//System.out.println(enc("8uEb#Lw*R_6gHdfe"));
    }
